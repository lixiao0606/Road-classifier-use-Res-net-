...
transform_BZ= transforms.Normalize(
    mean=[0.52165467, 0.5025819, 0.4910438],# 取决于数据集
    std=[0.09407499, 0.09147017, 0.0918781]
)
...
class LoadData(Dataset):
    def __init__(self, txt_path, train_flag=True):
        ...
        self.train_tf = transforms.Compose([
                ...
                transforms.RandomRotation(10, resample=False, expand=False, center=None),# 随机旋转 -10~10度
                #一半的概率进行3/4裁剪
